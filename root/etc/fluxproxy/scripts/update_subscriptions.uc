...
const ubus = connect();
const sing_features = ubus.call('luci.fluxproxy', 'singbox_get_features', {}) || {};
/* Common var end */

/* Log */
system(`mkdir -p ${RUN_DIR}`);
function log(...args) {
	const logfile = open(`${RUN_DIR}/fluxproxy.log`, 'a');
