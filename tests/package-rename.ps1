...
Assert-Match $readme 'ndx https://shallowhave\.github\.io/fluxproxy/releases/Packages\.adb' 'README should document the apk v3 repository index URL.'
Assert-Match $readme 'apk update' 'README should document updating the signed apk feed.'
Assert-Match $readme 'apk add luci-app-fluxproxy' 'README should document installing the signed apk package from the GitHub Pages feed.'
