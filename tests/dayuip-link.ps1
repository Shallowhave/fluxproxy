...
Assert-Match $clientView "_\('IP purchase'\)" 'Client page should display a translated IP purchase label.'
Assert-Match $serverView "_\('IP purchase'\)" 'Server page should display a translated IP purchase label.'
